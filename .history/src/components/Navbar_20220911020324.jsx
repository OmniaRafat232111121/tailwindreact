...
const Navbar = () => {
  ...
  <div className='h-100%'>
  <ul className={nav ? 'fixed left-0 top-0 w-[50%] mi-h-[50%] border-r border-r-gray-900 bg-[#2fb32f] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
