...
const Navbar = () => {
  ...
  return (
    ...
    <ul className={nav ? 'fixed left-0 top-0 w-[60%] h-full border-r border-r-purpl-900 bg-[#000300] ease-in-out duration-500' : 'ease-in-out duration-500 fixed left-[-100%]'}>
    <h1 className='w-full text-3xl font-bold text-purple-600 m-4'>REACT.</h1>
      <li className='p-4 border-b border-purpl-600'>Home</li>
      <li className='p-4 border-b border-purpl-600'>Company</li>
      <li className='p-4 border-b border-purpl-600'>Resources</li>
      <li className='p-4 border-b border-purpl-600'>About</li>
