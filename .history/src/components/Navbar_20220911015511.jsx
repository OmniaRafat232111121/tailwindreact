...
const Navbar = () => {
  ...
  return (
    ...
    <div>
    <ul className='fixed left-0 top-0 w-[60%] h-full border-r border-r--900 bg-[#000300] ease-in-out duration-500' >
    <h1 className='w-full text-3xl font-bold text-purple-600 m-4'>REACT.</h1>
      <li className='p-4 border-b border--600'>Home</li>
      <li className='p-4 border-b border--600'>Company</li>
      <li className='p-4 border-b border--600'>Resources</li>
      <li className='p-4 border-b border--600'>About</li>
